...
export default function TreeControls({ onAutoLayout }: TreeControlsProps) {
    ...
    <div className="absolute bottom-4 sm:bottom-6 right-4 sm:right-6 z-10 flex flex-col gap-2">
      ...
      {onAutoLayout && (
        <button
          ...
          className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-lg border-2 border-gray-300 bg-white shadow-md transition-all duration-200 hover:border-green-500 hover:shadow-lg hover:scale-110 active:scale-95"
          aria-label="Réorganiser automatiquement"
