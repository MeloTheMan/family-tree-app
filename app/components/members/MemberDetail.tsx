            ...
            <div className="flex-1 animate-slideInRight">
              ...
              {!readOnly && (
                <div className="flex gap-2 mt-6">
                  <button
                    onClick={onEdit}
                    className="flex-1 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-200 flex items-center gap-2 justify-center hover:scale-105 active:scale-95"
                  >
                  ...
                  {onDelete && (
                    <button
                      onClick={onDelete}
                      className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all duration-200 flex items-center gap-2 justify-center hover:scale-105 active:scale-95"
